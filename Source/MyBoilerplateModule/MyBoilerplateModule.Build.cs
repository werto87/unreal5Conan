...
public class MyBoilerplateModule : ModuleRules
{
	...
	private bool ProcessPrecomputedData(ReadOnlyTargetRules target, string engineVersion, string stagingDir)
	{
		...
		//Attempt to parse the JSON file containing any additional  0-s, modules and system libraries
	...
	public MyBoilerplateModule(ReadOnlyTargetRules Target) : base(Target)
	{
		Type = ModuleType.External;
		
		//Ensure our staging directory exists prior to copying any dependency data files into it
		string stagingDir = Path.Combine("$(ProjectDir)", "Binaries", "Data", "MyBoilerplateModule");
